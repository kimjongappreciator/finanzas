...
import com.upc.finanzas.service.impls.UserServiceImpl;
...
public class JwtAuthorizationFilterUser extends OncePerRequestFilter {
    private static final Logger logger = LoggerFactory.getLogger(JwtAuthorizationFilterUser.class);

    @Autowired
    private JwtHandlerUser handler;
